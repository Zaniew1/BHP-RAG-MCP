/*
  ...
  - Added the required column `chunkIndex` to the `Document` table without a default value. This is not possible if the table is not empty.
...
ADD COLUMN     "chunkIndex" TEXT NOT NULL,
